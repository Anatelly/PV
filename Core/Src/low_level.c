...
static void MX_GPIO_Init(void)
{
  ...
  PB1     ------> ADC1_INP5
  */
  GPIO_InitStruct.Pin = PIN_ADC_IN5;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = PIN_ADC_IN3;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = PIN_ADC_IN4;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  PA5     ------> DAC1_OUT2
  */
  GPIO_InitStruct.Pin = PIN_DAC1_OUT1|PIN_DAC1_OUT2;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  PA3     ------> USART2_RX
  */
  GPIO_InitStruct.Pin = PIN_UART2_RX|PIN_UART2_TX;
  ...
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
    ...
    */
    ...
    GPIO_InitStruct.Pin = PIN_SPI_SCK|PIN_SPI_MISO;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = PIN_I2C_SCL|PIN_I2C_SDA;
